...
const DemoComputer = (props) => {
  ...
  // Create video texture manually for more control
  const createVideoTexture = () => {
    const video = document.createElement('video');
    video.src = props.texture || '/textures/project/project1.mp4';
    video.ref = videoRef;
    video.muted = true;
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        ...
        <group
          name="RootNode" position={[0, 1.093, 0]} rotation={[-Math.PI / 2, 0, -0.033]} scale={0.045}>
          <group
            name="Screen001"
